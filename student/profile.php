...
<div class="profile-display">
    ...
    <div class="profile-grid">
        ...
        <div class="profile-card">
            ...
            <?php echo $profile['school']; ?></p>

            <p><strong>Faculty:</strong>
            <?php echo $profile['faculty']; ?></p>

            <p><strong>Department:</strong>
            <?php echo $profile['department']; ?></p>

            <p><strong>Level:</strong>
            <?php echo $profile['level']; ?></p>
        ...
        <div class="profile-card">
            ...
            <?php echo $profile['company_name']; ?></p>

            <p><strong>Supervisor:</strong>
            <?php echo $profile['industry_supervisor']; ?></p>

            <p><strong>Phone:</strong>
            <?php echo $profile['supervisor_phone']; ?></p>

            <p><strong>Address:</strong>
            <?php echo $profile['address']; ?></p>
